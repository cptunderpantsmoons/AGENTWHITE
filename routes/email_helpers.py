...
# Override at deploy time via WL_MAIL_ATTACHMENTS_DIR or legacy ODYSSEUS_MAIL_ATTACHMENTS_DIR
# subdir of the install's data/ tree so the app works out-of-the-box without
# a hardcoded /home/<user>/ path.
ATTACHMENTS_DIR = Path(os.environ.get("WL_MAIL_ATTACHMENTS_DIR", os.environ.get("ODYSSEUS_MAIL_ATTACHMENTS_DIR", str(DATA_DIR / "mail-attachments"))))
...
_IMAP_TIMEOUT_SECONDS = _coerce_imap_timeout_seconds(os.environ.get("WL_IMAP_TIMEOUT_SECONDS", os.environ.get("ODYSSEUS_IMAP_TIMEOUT_SECONDS")))
...
class SendEmailRequest(BaseModel):
    ...
    # Internal marker for app-generated mail (e.g. reminder, scheduled).
