...
INTERNAL_TOOL_TOKEN = os.environ.get("WL_INTERNAL_TOKEN") or os.environ.get("ODYSSEUS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = wl.internal_header("Token")
